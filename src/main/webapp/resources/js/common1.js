...
//Popup_mzone
(function($){
	$.fn.Popup_mZone = function(options) {
		var settings = {
			prevBtn : '',
			nextBtn : '',
			playBtn : '',
...
$(document).ready(function(){
	 $('.Popup_m').Popup_mZone({
		prevBtn : '.Popup_m_control .btn_prev',
		nextBtn : '.Popup_m_control .btn_next',
		playBtn : '.Popup_m_control .btn_pause',
		waitingTime : '8000'
	});

	$('.Popup_m_small').Popup_mZone({
		prevBtn : '.Popup_m_control2 .btn_prev',
		nextBtn : '.Popup_m_control2 .btn_next',
